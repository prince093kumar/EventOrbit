...
import { Mail, User, ArrowRight, Loader2, Eye, EyeOff, ArrowLeft } from 'lucide-react';
...
const SignUp = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const { success, error: apiError } = await signup(formData.name, formData.email, formData.password, 'organizer');
        ...
        <div className="min-h-screen bg-[var(--bg-page)] flex items-center justify-center p-4">
            <div className="w-full max-w-md bg-[var(--bg-card)] rounded-2xl shadow-xl overflow-hidden border border-[var(--border-color)]">
                ...
                <div className="relative p-8 text-center bg-gradient-to-br from-[#FFDA8A] to-[#ffc107] text-gray-900">
                    ...
                    <h2 className="text-3xl font-bold mb-2">Organizer Join</h2>
